...
print('Well ' + str('\033[1m{}\033[0m'.format(userName.title())) + ', I am thinking of a number between' + '\033[1m{}\033[0m'.format(' 1 ')
      + 'and' + '\033[1m{}\033[0m'.format(' 20.') + '\nYou can ask for a hint by typing \''
      + '\033[1m{}\033[0m'.format('hint') + '\' or type'
      + ' \'' + '\033[1m{}\033[0m'.format('exit') + '\' if you\'re done playing.')
...
while userNumber != computerNumber:
    ...
    if userNumber.lower() == 'exit':
        print('You played a good game! The number I chose was: ' + str('\033[1m{}\033[0m'.format(computerNumber)))
        ...
        if playAgain == 'y' or playAgain == 'yes':
            ...
            print('Alright, let\'s play another game:\nI\'m thinking of a number between ' +
                  '\033[1m{}\033[0m'.format('1') + ' and ' + '\033[1m{}\033[0m'.format('20'))
    ...
    # if the number guessed is identical to the computer number
        ...
        print('Great job ' + '\033[1m{}\033[0m'.format(userName.title()) +
        '!  You guessed my number in ' + '\033[1m{}\033[0m'.format(roundsPlayed) + ' round(s)!')
        ...
        if anotherRound.lower() == 'y' or anotherRound.lower() == 'yes':
            print('\nAlright, let\'s go!  I\'m thinking of another number between '
                  + '\033[1m{}\033[0m'.format('1') + ' and ' + '\033[1m{}\033[0m'.format('20'))

            print('Don\'t forget you can always type \'' + '\033[1m{}\033[0m'.format('exit')
                  + '\' or \'' + '\033[1m{}\033[0m'.format('hint') + '\' if you\'re stuck.')
            roundsPlayed = 0 # to reset variables
            computerNumber = random.randint(1, 20)
